...
- Панель горизонта визуализирует азимуты и возвышения доступных спутников в виде цветных маркеров; кликом по маркеру можно выбрать аппарат. Текстовое уведомление поясняет, почему список пуст (нет TLE, не загружены координаты, спутники ниже порога).
