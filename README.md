...
При запуске `serial_radio_control.ino` устройство поднимает точку доступа Wi‑Fi `sat_ap` (пароль `12345678`) и простой HTTP‑сервер на порту `80`, доступный по адресу `http://192.168.4.1/`.
...
## Что осталось сделать
  - Раздавать полноценный веб-интерфейс с устройства и связать его логику по сети.
  - Связать веб-интерфейс с логикой проекта и реализовать полноценную обработку вкладок и безопасности.
