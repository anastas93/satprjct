...
- `loop()` — обработка HTTP-запросов и событий приёма пакетов от SX1262.
...
- ✅ Реализовано: проект PlatformIO `Lotest`, веб-интерфейс управления, выбор каналов банка HOME, переключение мощности -5/22 dBm, отправка пакетов (фиксированная длина 4/8/16/32/64 байта, полный и произвольный), вывод всех событий в чат, приём и отображение пакетов.
