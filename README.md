...
Добавлен банк `NEW` (буква `n`/`N`) — это 146 новых каналов (индексы 163–308) из полного списка `ALL`.
Он позволяет быстро переключаться на свежедобавленные частоты без пролистывания всего массива.
