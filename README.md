...
- Рядом с надписью Local/Remote по умолчанию отображаются прочерки, но добавлена кнопка **Key Hash** для просмотра 4‑значного хеша текущего ключа.
...
- Добавлена кнопка **Clean** для очистки чата.
