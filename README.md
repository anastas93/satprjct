...
- Кнопка **Ping** измеряет задержку и сохраняет историю последних 10 измерений (RSSI, SNR, расстояние, время).
- Кнопка **Metrics** выводит текущую статистику передачи и приёма.
