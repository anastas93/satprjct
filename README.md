...
- **Надёжность обмена**: `PacketGatherer` синхронизирует длину частей по первому фрагменту и сбрасывается при
  ...
  автоматически очищает повреждённую конфигурацию core dump во флеше прямым стиранием соответствующего раздела,
  что устраняет assert FreeRTOS на однопроцессорных сборках.
