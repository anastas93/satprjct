...
Системные ответы выделяются отдельным оттенком, а статусы `TX:…` отображаются мелкой подписью в правом нижнем углу пузырька, что облегчает контроль подтверждений.
