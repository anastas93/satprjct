...
- Кнопка «Очистить список» вызывает функцию `clearReceivedList()`, которая сбрасывает кеш имён и
  мгновенно показывает заглушку для пустого списка входящих сообщений.
