...
- `formatByteArray()`, `formatTextPayload()`, `describeFrameMarker()`, `logReceivedMessage()` — вспомогательные функции форматирования и подсветки событий.
...
- ✅ Реализовано: проект PlatformIO `Lotest`, веб-интерфейс управления, выбор каналов банка HOME, переключение мощности -5/22 dBm, SF7/SF5, настройка полосы 7.81–20.83 кГц и коэффициента кодирования 4/5–4/8, отправка пакетов (длинный 124-байтовый, полный случайный и текстовый с автоматическим дроблением по 8 байт), вывод событий в чат с выделением входящих сообщений, приём и сборка пакетов, детализированное логирование всех IRQ SX1262, совместимость с новыми версиями RadioLib для чтения/очистки IRQ.
