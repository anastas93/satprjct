...
- Переключатель «Light pack — прямой текст» переводит передачу в минимальный режим: текст из чата
  отправляется без служебного префикса, а принятые пакеты отображаются без заголовков.
...
- `LIGHT [0|1]` — включить или выключить режим прямой отправки текста (Light pack).
