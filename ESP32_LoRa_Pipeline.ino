...
void handleRoot() {
  // Serve an enhanced control panel.  The interface is organized into
  // collapsible sections, supports dark/light mode, adjustable font size,
  // profiles for quick configuration, and displays recent ping metrics.  It
  // includes descriptive titles and tooltips for accessibility.  Chat lines
  // are prepended to keep the latest messages in view.
...
<body class="dark">
  ...
  // Replace checkbox placeholders with current values for ACK and ENC
