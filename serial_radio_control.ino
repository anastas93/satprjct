...
// Предварительное объявление структуры буфера отладочного лога, чтобы автогенерация
// прототипов Arduino корректно обрабатывала функции, использующие DebugLogEntry.
